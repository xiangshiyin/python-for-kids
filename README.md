...
You can pick either local or online programming tools to practice coding. Please follow the instructions below accordingly to set up the coding environment before our class. If you face challenges, please [reach out](#contact) and we can figure it out together.

您可以选择线下或者线上的编程工具实现编程练习和操作，请您按照下列方式在课前设置好编程环境。如果您遇到问题可以联系老师，我们可以一起想办法解决。

## Internet @ ACCA
If you choose online coding tools, you would need internet connections during our class. Please follow the instructions [here](https://docs.google.com/presentation/d/1Q35y-fWR4LwFnihzVuaolTxWZ5rCQaf694ZdCtju6yw/edit#slide=id.g146323da375_0_0) to connect the wifi network in the school campus
* **You would need to recreate internet connection credentials every 7 days**

如果您选择线上工具，您需要在上课时用电脑上网，相应的联网方式可以按照[这里](https://docs.google.com/presentation/d/1Q35y-fWR4LwFnihzVuaolTxWZ5rCQaf694ZdCtju6yw/edit#slide=id.g146323da375_0_0)的说明。
* **您需要每隔7天重设一次网络登录账户**
...
如果场地网络信号不佳，我们可以尝试在本地电脑安装软件来实现程序编写和运行。**希望您课前**可以通过 https://www.anaconda.com/products/distribution 下载和安装软件Anaconda到您的电脑
